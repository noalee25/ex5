...
/**
 * class that has all the needed regex
 */
public class RegexBank {
     ...
     */
    public static final Pattern PARAM_TOKEN = Pattern.compile
            ("^\\s*(final\\s+)?(int|double|boolean|char|String)\\s+([A-Za-z_][A-Za-z0-9_]*)\\s*$");
